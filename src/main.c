...
int8_t ADS1110_Platform_Init(void)
{
  i2c_config_t conf = {0};
...
int8_t ADS1110_Platform_DeInit(void)
{
...
int8_t ADS1110_Platform_Send(uint8_t Address, uint8_t *Data, uint8_t DataLen)
{
...
int8_t ADS1110_Platform_Receive(uint8_t Address, uint8_t *Data, uint8_t DataLen)
{
  i2c_cmd_handle_t ADS1110_i2c_cmd_handle = {0};
  Address <<= 1;
  Address |= 0x01;
